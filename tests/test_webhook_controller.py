...
class TestWebhookController(HttpCase):
    ...
    def setUp(self):
        ...
        self.env["ir.config_parameter"].sudo().set_param(
            "sms_es_connector.webhook_token", self.token
        )
        ...
        msg = self.SmsMessage.create(
            {
                ...
                "sender": "Odoo",
                "receiver": "777888999",
                "text": "Test DLR processing.",
                "state": "api_sent",
                "msg_id": "api-uuid-should-be-ignored",
            }
        )
    ...
    def test_03_webhook_successful_dlr_fallback_msgid(self):
        """Prueba el procesamiento exitoso de un DLR
        usando el msgId como fallback."""
        msg_uuid = "api-uuid-for-fallback-test"
        msg = self.SmsMessage.create(
            {
                "name": "Test DLR Fallback",
                "sender": "Odoo",
                "receiver": "123123123",
                "text": "Test DLR processing.",
                "state": "api_sent",
